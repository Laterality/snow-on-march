...
public class MessageLogAdapter extends RealmRecyclerViewAdapter<MessageDBO, MessageLogAdapter.ViewHolder> {

	public MessageLogAdapter(OrderedRealmCollection<MessageDBO> data) {
		super(data, true);
	}
